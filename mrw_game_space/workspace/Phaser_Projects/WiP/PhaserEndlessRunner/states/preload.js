...
class PreLoad extends Phaser.State
{
    preload() {
        ...
        this.game.load.image('clouds', 'states/images/game/platform.png');
        this.game.load.image('block', 'states/images/game/block.png');
        this.game.load.image('star', 'states/images/game/star.png');
        this.game.load.image('bird', 'states/images/game/diamond.png');
        this.game.load.spritesheet('hero', 'states/images/game/hero.png');
